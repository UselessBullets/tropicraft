...
public class ChunkDecoratorTropicsAPI extends ChunkDecoratorAPI {
	public static TerrainTropicsConfig tropicsConfig = ConfigManager.getConfig("tropics", TerrainTropicsConfig.class);
	...
	public static OverworldOreFeatures oreFeatures = new OverworldOreFeatures(tropicsConfig);
	...
	public ChunkDecoratorTropicsAPI(World world, int treeDensityOverride) {
		super(world);
		this.treeDensityOverride = treeDensityOverride;
		this.treeDensityNoise = new PerlinNoise(world.getRandomSeed(), 8, 74);
	}

	public ChunkDecoratorTropicsAPI(World world) {
		this(world, -1);
	}
